 ...
 */
QString Job::replaceSpecialChars(const QString &str, bool quote, QMap<QString, QString> _map){
  ...
  if (quote)
      return KMacroExpander::expandMacrosShellQuote(str, map);
  else
      return KMacroExpander::expandMacros(str, map);
}
