...
public:
	inline Job(QObject *parent = nullptr):QObject(parent),id(-1),track_title(""),track_artist(""), track(-1),track_comment(""), year(-1), genre(i18n("Other")), group(""), album(""), comment(""), lastSongInAlbum(false), removeTempFile(false), encoder(-1) {}
